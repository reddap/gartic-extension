...
var fodida = setInterval(() => {
    document.querySelector("#blocoJogar > div.conteudo > button") &&
        ...
        (document.querySelector("#blocoJogar > div.conteudo").appendChild(document.createElement("p")).innerHTML =
            "<p align='center'> status: novo quick-tutorial<br> <a  target='_blank' href='https://github.com/reddap/gartic-extension/' style='text-decoration:none'> como tirar o delay do enter</a><br><i>latest update 07-03-2022 - by <a  target='_blank' href='https://discord.com/' style='text-decoration:none'> padder#7724</a></i><p>"));
}, 333);
